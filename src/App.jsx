...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-[#1f1f1f]">
      ...
      {/* Footer */}
      <footer className="bg-white dark:bg-[#2a2a2a] border-t border-gray-200 dark:border-[#3a3a3a] mt-12">
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center text-sm text-gray-600 dark:text-gray-400">
            <p>
              (Un)Archived V - YouTube Stream Archiving Service
            </p>
            <p className="mt-1">
              Automatically downloads streams matching your keywords from subscribed channels
            </p>
          </div>
        </div>
      </footer>
